...
public class ChickenBeefResultB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chicken_beef_result_b);
        ...
        inputRecipe1.setOnClickListener(view -> {
            Intent intent = new Intent(ChickenBeefResultB.this, ChickenRecipe4.class);
            startActivity(intent);
        });
        inputRecipe2.setOnClickListener(view -> {
            Intent intent = new Intent(ChickenBeefResultB.this, ChickenRecipe7.class);
            startActivity(intent);
        });
        inputRecipe3.setOnClickListener(view -> {
            Intent intent = new Intent(ChickenBeefResultB.this, BeefRecipe2.class);
            startActivity(intent);
        });
        inputRecipe4.setOnClickListener(view -> {
            Intent intent = new Intent(ChickenBeefResultB.this, BeefRecipe3.class);
            startActivity(intent);
        });
        inputRecipe5.setOnClickListener(view -> {
            Intent intent = new Intent(ChickenBeefResultB.this, BeefRecipe4.class);
            startActivity(intent);
        });
        inputRecipe6.setOnClickListener(view -> {
            Intent intent = new Intent(ChickenBeefResultB.this, BeefRecipe5.class);
            startActivity(intent);
        });
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                redirectActivity(ChickenBeefResultB.this, StartActivity.class);
            }
        });
        ...
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(ChickenBeefResultB.this, AboutActivity.class);
            }
        });
        terms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(ChickenBeefResultB.this, TermsOfUseActivity.class);
            }
        });
        policy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(ChickenBeefResultB.this, PrivacyPolicyActivity.class);
            }
        });
    }
