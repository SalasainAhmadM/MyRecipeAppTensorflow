...
public class BeefResult13456Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beef_result13456);
        ...
        inputRecipe1.setOnClickListener(view -> {
            Intent intent = new Intent(BeefResult13456Activity.this, BeefRecipe1.class);
            startActivity(intent);
        });
        inputRecipe2.setOnClickListener(view -> {
            Intent intent = new Intent(BeefResult13456Activity.this, BeefRecipe3.class);
            startActivity(intent);
        });
        inputRecipe3.setOnClickListener(view -> {
            Intent intent = new Intent(BeefResult13456Activity.this, BeefRecipe4.class);
            startActivity(intent);
        });
        inputRecipe4.setOnClickListener(view -> {
            Intent intent = new Intent(BeefResult13456Activity.this, BeefRecipe5.class);
            startActivity(intent);
        });
        inputRecipe5.setOnClickListener(view -> {
            Intent intent = new Intent(BeefResult13456Activity.this, BeefRecipe6.class);
            startActivity(intent);
        });
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                redirectActivity(BeefResult13456Activity.this, StartActivity.class);
            }
        });
        ...
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(BeefResult13456Activity.this, AboutActivity.class);
            }
        });
        terms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(BeefResult13456Activity.this, TermsOfUseActivity.class);
            }
        });
        policy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(BeefResult13456Activity.this, PrivacyPolicyActivity.class);
            }
        });
    }
