...
public class SeafoodResult45J extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seafood_result45_j);
        ...
        inputRecipe1.setOnClickListener(view -> {
            Intent intent = new Intent(SeafoodResult45J.this, SeafoodRecipe4.class);
            startActivity(intent);
        });
        inputRecipe2.setOnClickListener(view -> {
            Intent intent = new Intent(SeafoodResult45J.this, SeafoodRecipe5.class);
            startActivity(intent);
        });
        ...
        exit.setOnClickListener(view -> redirectActivity(SeafoodResult45J.this, StartActivity.class));
        menu.setOnClickListener(view -> openDrawer(drawerLayout));
        about.setOnClickListener(view -> redirectActivity(SeafoodResult45J.this, AboutActivity.class));
        terms.setOnClickListener(view -> redirectActivity(SeafoodResult45J.this, TermsOfUseActivity.class));
        policy.setOnClickListener(view -> redirectActivity(SeafoodResult45J.this, PrivacyPolicyActivity.class));
    }
