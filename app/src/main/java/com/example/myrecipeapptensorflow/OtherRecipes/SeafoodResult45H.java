...
public class SeafoodResult45H extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seafood_result45_h);
        ...
        inputRecipe1.setOnClickListener(view -> {
            Intent intent = new Intent(SeafoodResult45H.this, SeafoodRecipe4.class);
            startActivity(intent);
        });
        inputRecipe2.setOnClickListener(view -> {
            Intent intent = new Intent(SeafoodResult45H.this, SeafoodRecipe5.class);
            startActivity(intent);
        });
        ...
        exit.setOnClickListener(view -> redirectActivity(SeafoodResult45H.this, StartActivity.class));
        menu.setOnClickListener(view -> openDrawer(drawerLayout));
        about.setOnClickListener(view -> redirectActivity(SeafoodResult45H.this, AboutActivity.class));
        terms.setOnClickListener(view -> redirectActivity(SeafoodResult45H.this, TermsOfUseActivity.class));
        policy.setOnClickListener(view -> redirectActivity(SeafoodResult45H.this, PrivacyPolicyActivity.class));
    }
