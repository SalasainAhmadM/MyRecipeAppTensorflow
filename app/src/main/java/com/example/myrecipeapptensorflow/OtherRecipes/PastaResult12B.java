...
import com.example.myrecipeapptensorflow.PastaRecipes.PastaRecipe2;
...
public class PastaResult12B extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pasta_result12_b);
        ...
        inputRecipe1.setOnClickListener(view -> {
            Intent intent = new Intent(PastaResult12B.this, PastaRecipe1.class);
            startActivity(intent);
        });
        inputRecipe2.setOnClickListener(view -> {
            Intent intent = new Intent(PastaResult12B.this, PastaRecipe2.class);
            startActivity(intent);
        });
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                redirectActivity(PastaResult12B.this, StartActivity.class);
            }
        });
        ...
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(PastaResult12B.this, AboutActivity.class);
            }
        });
        terms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(PastaResult12B.this, TermsOfUseActivity.class);
            }
        });
        policy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(PastaResult12B.this, PrivacyPolicyActivity.class);
            }
        });
    }
