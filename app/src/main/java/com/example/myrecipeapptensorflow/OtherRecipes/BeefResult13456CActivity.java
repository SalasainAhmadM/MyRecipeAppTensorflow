...
public class BeefResult13456CActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beef_result13456_cactivity);
        ...
        inputRecipe1.setOnClickListener(view -> {
            Intent intent = new Intent(BeefResult13456CActivity.this, BeefRecipe1.class);
            startActivity(intent);
        });
        inputRecipe2.setOnClickListener(view -> {
            Intent intent = new Intent(BeefResult13456CActivity.this, BeefRecipe3.class);
            startActivity(intent);
        });
        inputRecipe3.setOnClickListener(view -> {
            Intent intent = new Intent(BeefResult13456CActivity.this, BeefRecipe4.class);
            startActivity(intent);
        });
        inputRecipe4.setOnClickListener(view -> {
            Intent intent = new Intent(BeefResult13456CActivity.this, BeefRecipe5.class);
            startActivity(intent);
        });
        inputRecipe5.setOnClickListener(view -> {
            Intent intent = new Intent(BeefResult13456CActivity.this, BeefRecipe6.class);
            startActivity(intent);
        });
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                redirectActivity(BeefResult13456CActivity.this, StartActivity.class);
            }
        });
        ...
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(BeefResult13456CActivity.this, AboutActivity.class);
            }
        });
        terms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(BeefResult13456CActivity.this, TermsOfUseActivity.class);
            }
        });
        policy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(BeefResult13456CActivity.this, PrivacyPolicyActivity.class);
            }
        });
    }
