...
public class SeafoodResult45G extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seafood_result45_g);
        ...
        inputRecipe1.setOnClickListener(view -> {
            Intent intent = new Intent(SeafoodResult45G.this, SeafoodRecipe4.class);
            startActivity(intent);
        });
        inputRecipe2.setOnClickListener(view -> {
            Intent intent = new Intent(SeafoodResult45G.this, SeafoodRecipe5.class);
            startActivity(intent);
        });
        ...
        exit.setOnClickListener(view -> redirectActivity(SeafoodResult45G.this, StartActivity.class));
        menu.setOnClickListener(view -> openDrawer(drawerLayout));
        about.setOnClickListener(view -> redirectActivity(SeafoodResult45G.this, AboutActivity.class));
        terms.setOnClickListener(view -> redirectActivity(SeafoodResult45G.this, TermsOfUseActivity.class));
        policy.setOnClickListener(view -> redirectActivity(SeafoodResult45G.this, PrivacyPolicyActivity.class));
    }
