...
public class SeafoodResult45D extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seafood_result45_d);
        ...
        inputRecipe1.setOnClickListener(view -> {
            Intent intent = new Intent(SeafoodResult45D.this, SeafoodRecipe4.class);
            startActivity(intent);
        });
        inputRecipe2.setOnClickListener(view -> {
            Intent intent = new Intent(SeafoodResult45D.this, SeafoodRecipe5.class);
            startActivity(intent);
        });
        ...
        exit.setOnClickListener(view -> redirectActivity(SeafoodResult45D.this, StartActivity.class));
        menu.setOnClickListener(view -> openDrawer(drawerLayout));
        about.setOnClickListener(view -> redirectActivity(SeafoodResult45D.this, AboutActivity.class));
        terms.setOnClickListener(view -> redirectActivity(SeafoodResult45D.this, TermsOfUseActivity.class));
        policy.setOnClickListener(view -> redirectActivity(SeafoodResult45D.this, PrivacyPolicyActivity.class));
    }
