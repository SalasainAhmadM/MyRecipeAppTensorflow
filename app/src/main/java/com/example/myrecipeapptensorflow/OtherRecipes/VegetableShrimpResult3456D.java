...
public class VegetableShrimpResult3456D extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vegetable_shrimp_result3456_d);
        ...
        inputRecipe1.setOnClickListener(view -> {
            Intent intent = new Intent(VegetableShrimpResult3456D.this, VegetableRecipe3.class);
            startActivity(intent);
        });
        inputRecipe2.setOnClickListener(view -> {
            Intent intent = new Intent(VegetableShrimpResult3456D.this, VegetableRecipe4.class);
            startActivity(intent);
        });
        inputRecipe3.setOnClickListener(view -> {
            Intent intent = new Intent(VegetableShrimpResult3456D.this, VegetableRecipe5.class);
            startActivity(intent);
        });
        inputRecipe4.setOnClickListener(view -> {
            Intent intent = new Intent(VegetableShrimpResult3456D.this, VegetableRecipe6.class);
            startActivity(intent);
        });
        inputRecipe5.setOnClickListener(view -> {
            Intent intent = new Intent(VegetableShrimpResult3456D.this, SeafoodRecipe2.class);
            startActivity(intent);
        });
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                redirectActivity(VegetableShrimpResult3456D.this, StartActivity.class);
            }
        });
        ...
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(VegetableShrimpResult3456D.this, AboutActivity.class);
            }
        });
        terms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(VegetableShrimpResult3456D.this, TermsOfUseActivity.class);
            }
        });
        policy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                redirectActivity(VegetableShrimpResult3456D.this, PrivacyPolicyActivity.class);
            }
        });
    }
